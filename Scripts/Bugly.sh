...
# # 注意: 请配置下面的信息
################################################################################
BUGLY_APP_ID="b118bf8efa"
BUGLY_APP_KEY="b2c9c0fa-0a39-400e-b927-d9c6b7f8bbe8"
BUNDLE_IDENTIFIER="cn.msh.mobilebank.ios.user"
################################################################################
# # 自定义配置
################################################################################
...
BUGLY_SYMBOL_JAR_PATH="${SRCROOT}/../Scripts/buglySymboliOS.jar"
